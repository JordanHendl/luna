...
Device::Device(io::Dlloader& loader, vk::AllocationCallbacks* callback,
                        vk::PhysicalDevice device, vk::DispatchLoaderDynamic& dispatch) {
  ...
  this->m_dispatch.init(global_resources().instance.m_instance,
