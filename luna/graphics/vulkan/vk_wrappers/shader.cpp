...
Shader::Shader(Device& device, std::vector<std::pair<gfx::ShaderType, std::vector<uint32_t>>> spirv) {
  this->m_rate = vk::VertexInputRate::eVertex;
  this->m_device = &device;
  this->m_file = std::make_unique<gfx::Shader>(spirv);
...
Shader::Shader(Device& device,
  ...
  this->m_rate = vk::VertexInputRate::eVertex;
  this->m_device = &device;
  this->m_file = std::make_unique<gfx::Shader>(inline_files);
